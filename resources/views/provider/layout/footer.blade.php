<footer class="bg-gray-100 dark:bg-gray-800">
    @if(request()->routeIs('home'))
        <div class="container mx-auto px-4 py-5 md:mb-5">
            <div class="flex flex-wrap -mx-4">
                ...
                <a class="inline-block mb-0 text-gray-900 text-lg font-semibold" href="#"><img class="h-7" src="{{ asset('img/assets/logo/logo-zeus-red.svg') }}" alt="" width="auto"></a>
                <p class="mb-6 max-w-sm text-sm text-gray-500">Lorem ipsum dolor sit amet, consectetur adipiscing elitsit amet, consectetur adipiscing elit.</p>
                <div class="flex">
                ...
                <div class="flex flex-wrap justify-between -mx-4">
                    <div class="w-1/2 lg:w-1/4 px-4 mb-8 lg:mb-0">
                        <h3 class="mb-1 text-base font-medium">Company</h3>
                        <ul class="text-sm">
                            <li class="mb-2"><a class="text-gray-500 hover:text-gray-600" href="#">About Us</a></li>
                            <li class="mb-2"><a class="text-gray-500 hover:text-gray-600" href="#">Careers</a></li>
                            <li class="mb-2"><a class="text-gray-500 hover:text-gray-600" href="#">Press</a></li>
                            <li><a class="text-gray-500 hover:text-gray-600" href="#">Blog</a></li>
                        </ul>
                    </div>
                    <div class="w-1/2 lg:w-1/4 px-4 mb-8 lg:mb-0">
                        <h3 class="mb-1 text-base font-medium">Pages</h3>
                        <ul class="text-sm">
                            <li class="mb-2"><a class="text-gray-500 hover:text-gray-600" href="#">Login</a></li>
                            <li class="mb-2"><a class="text-gray-500 hover:text-gray-600" href="#">Register</a></li>
                            <li class="mb-2"><a class="text-gray-500 hover:text-gray-600" href="#">Add list</a></li>
                            <li><a class="text-gray-500 hover:text-gray-600" href="#">Contact</a></li>
                        </ul>
                    </div>
                    <div class="w-1/2 lg:w-1/4 px-4 mb-8 lg:mb-0">
                        <h3 class="mb-1 text-base font-medium">Legal</h3>
                        <ul class="text-sm">
                            <li class="mb-2"><a class="text-gray-500 hover:text-gray-600" href="{{ route('tnc') }}">Terms</a></li>
                            <li class="mb-2"><a class="text-gray-500 hover:text-gray-600" href="#">About Us</a></li>
                            <li class="mb-2"><a class="text-gray-500 hover:text-gray-600" href="{{ route('faq') }}">FAQs</a></li>
                            <li><a class="text-gray-500 hover:text-gray-600" href="{{ route('privacy') }}">Privacy</a></li>
                        </ul>
                    </div>
                    <div class="w-1/2 lg:w-1/4 px-4">
                        <h3 class="mb-1 text-base font-medium">Resources</h3>
                        <ul class="text-sm">
                            <li class="mb-2"><a class="text-gray-500 hover:text-gray-600" href="#">Blog</a></li>
                            <li class="mb-2"><a class="text-gray-500 hover:text-gray-600" href="#">Service</a></li>
                            <li class="mb-2"><a class="text-gray-500 hover:text-gray-600" href="#">Product</a></li>
    ...
    @endif
    <p class="text-center text-sm text-gray-500 dark:text-gray-300 py-5 px-4 border-t dark:border-gray-700">All rights reserved &copy; Zeus Corporation 2021</p>
</footer>