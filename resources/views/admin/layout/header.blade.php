    ...
    <div class="container flex items-center justify-between h-full px-6 mx-auto text-purple-600 dark:text-purple-300"
        ...
        <ul class="flex items-center flex-shrink-0 space-x-6">
                ...
                <div class="relative inline-block text-left">
                    ...
                    @endphp
                        <button x-transition:leave="transition ease-in duration-150" x-transition:leave-start="opacity-100"
                            ...
                            class="px-4 py-2 font-bold border-2 border-blue-500 rounded bg-purple-50 dark:bg-gray-700 text-gray dark:text-white hover:border-blue-500 active:bg-purple-600 focus:outline-none focus:shadow-outline-purple"
            ...
            @if(config('constants.demo_mode', '') == '1')
                <li class="flex">
                    <button class="px-4 py-2 font-bold border-2 border-blue-500 rounded bg-purple-50 dark:bg-gray-700 text-gray dark:text-white hover:border-blue-500 active:bg-purple-600 focus:outline-none focus:shadow-outline-purple">
                        Demo Mode Active
                    </button>
                </li>
            @endif
            ...
            <li class="relative">
                <button class="align-middle rounded-full focus:shadow-outline-purple focus:outline-none"
                    ...
                    aria-haspopup="true">
                    <img class="object-cover w-8 h-8 rounded-full" src="{{ auth()->user()->avatar ? asset('storage/'.auth()->user()->avatar) : asset('img/avatar.png') }} " alt=""
                        aria-hidden="true" />
                </button>
                    ...
                    <ul x-transition:leave="transition ease-in duration-150" x-transition:leave-start="opacity-100"
                        ...
                        <li class="flex">
                            <a class="inline-flex items-center w-full px-2 py-1 text-sm font-semibold transition-colors duration-150 rounded-md hover:bg-gray-100 hover:text-gray-800 dark:hover:bg-gray-800 dark:hover:text-gray-200"
                                ...
                                <i class="mr-3 fa fa-picture-o"></i>
