            ...
            <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                ...
                @forelse ($serviceTypes as $serviceType)
                    ...
                    <tr class="text-gray-700 dark:text-gray-400">
                        ...
                        <td
                            class="px-4 dark:text-gray-400 dark:bg-gray-800 py-3 text-sm @if(!$serviceType->subServices->count()) text-center @endif">
                            @forelse ($serviceType->subServices as $service)
                                {{ $service->name }}
                                @if (!$loop->last)
                                ,
                                @endif
